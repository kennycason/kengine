...
class RenderCommandBufferTest {
    ...
    fun storesCommandFieldsInOrder() {
        val commands = RenderCommandBuffer(capacity = 6)
        ...
        commands.drawTriangle(x1 = 82, y1 = 84, x2 = 86, y2 = 88, x3 = 90, y3 = 92, color = 0x05060708)
        ...
        assertEquals(RenderCommandType.DRAW_TRIANGLE, commands.field(3, RenderCommandBuffer.FIELD_TYPE))
        assertEquals(82, commands.field(3, RenderCommandBuffer.FIELD_X))
        assertEquals(84, commands.field(3, RenderCommandBuffer.FIELD_Y))
        assertEquals(86, commands.field(3, RenderCommandBuffer.FIELD_WIDTH))
        assertEquals(88, commands.field(3, RenderCommandBuffer.FIELD_HEIGHT))
        assertEquals(0x05060708, commands.field(3, RenderCommandBuffer.FIELD_COLOR))
        assertEquals(90, commands.field(3, RenderCommandBuffer.FIELD_COLOR2))
        assertEquals(92, commands.field(3, RenderCommandBuffer.FIELD_PARAM))
        assertEquals(RenderCommandType.DRAW_SPRITE, commands.field(4, RenderCommandBuffer.FIELD_TYPE))
        assertEquals(90, commands.field(4, RenderCommandBuffer.FIELD_X))
        assertEquals(100, commands.field(4, RenderCommandBuffer.FIELD_Y))
        assertEquals(110, commands.field(4, RenderCommandBuffer.FIELD_WIDTH))
        assertEquals(120, commands.field(4, RenderCommandBuffer.FIELD_HEIGHT))
        assertEquals(0x11121314, commands.field(4, RenderCommandBuffer.FIELD_COLOR))
        assertEquals(spriteId, commands.field(4, RenderCommandBuffer.FIELD_COLOR2))
        assertEquals(3, commands.field(4, RenderCommandBuffer.FIELD_PARAM))
        assertEquals(RenderCommandType.DRAW_TEXT, commands.field(5, RenderCommandBuffer.FIELD_TYPE))
        assertEquals(130, commands.field(5, RenderCommandBuffer.FIELD_X))
        assertEquals(140, commands.field(5, RenderCommandBuffer.FIELD_Y))
        assertEquals(4, commands.field(5, RenderCommandBuffer.FIELD_WIDTH))
        assertEquals(0x21222324, commands.field(5, RenderCommandBuffer.FIELD_COLOR))
        assertEquals("KENGINE", commands.text(5))
    }
