...
class RenderContextTest {
    ...
    fun recordsDrawCommandsThroughContext() {
        val render = RenderContext(commandCapacity = 6)
        ...
        render.drawTriangle(x1 = 82, y1 = 84, x2 = 86, y2 = 88, x3 = 90, y3 = 92, color = 0x35363738)
        ...
        assertEquals(6, render.commandCount)
        ...
        assertEquals(RenderCommandType.DRAW_TRIANGLE, render.commandField(3, RenderCommandBuffer.FIELD_TYPE))
        assertEquals(82, render.commandField(3, RenderCommandBuffer.FIELD_X))
        assertEquals(84, render.commandField(3, RenderCommandBuffer.FIELD_Y))
        assertEquals(86, render.commandField(3, RenderCommandBuffer.FIELD_WIDTH))
        assertEquals(88, render.commandField(3, RenderCommandBuffer.FIELD_HEIGHT))
        assertEquals(0x35363738, render.commandField(3, RenderCommandBuffer.FIELD_COLOR))
        assertEquals(90, render.commandField(3, RenderCommandBuffer.FIELD_COLOR2))
        assertEquals(92, render.commandField(3, RenderCommandBuffer.FIELD_PARAM))
        assertEquals(RenderCommandType.DRAW_SPRITE, render.commandField(4, RenderCommandBuffer.FIELD_TYPE))
        assertEquals(90, render.commandField(4, RenderCommandBuffer.FIELD_X))
        assertEquals(100, render.commandField(4, RenderCommandBuffer.FIELD_Y))
        assertEquals(110, render.commandField(4, RenderCommandBuffer.FIELD_WIDTH))
        assertEquals(120, render.commandField(4, RenderCommandBuffer.FIELD_HEIGHT))
        assertEquals(0x41424344, render.commandField(4, RenderCommandBuffer.FIELD_COLOR))
        assertEquals(spriteId, render.commandField(4, RenderCommandBuffer.FIELD_COLOR2))
        assertEquals(5, render.commandField(4, RenderCommandBuffer.FIELD_PARAM))
        assertEquals(RenderCommandType.DRAW_TEXT, render.commandField(5, RenderCommandBuffer.FIELD_TYPE))
        assertEquals(130, render.commandField(5, RenderCommandBuffer.FIELD_X))
        assertEquals(140, render.commandField(5, RenderCommandBuffer.FIELD_Y))
        assertEquals(3, render.commandField(5, RenderCommandBuffer.FIELD_WIDTH))
        assertEquals(0x51525354, render.commandField(5, RenderCommandBuffer.FIELD_COLOR))
        assertEquals("SCORE 123", render.commandText(5))
    }
