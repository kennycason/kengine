...
- `assets/models/Super Mario 64 Bowser.glb`: small textured Bowser landmark/enemy mesh placed near Ridley. This file also has no skins or animation clips.
...
3. Add GLB animation playback in two phases: node transform animation for simple files like Goomba, then skeletal skinning for the large external Mario source GLB.
4. Extract only the needed Mario clips into repo-safe files once skeletal playback exists.
