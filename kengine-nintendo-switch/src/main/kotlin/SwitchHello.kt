...
fun kengineSwitchAdd(a: Int, b: Int): Int {
    return a + b
}

fun kengineSwitchMessageCode(): Int {
    return 2026
}

fun kengineSwitchAllocationProbe(seed: Int, size: Int): Int {
...
fun kengineSwitchProbeMessage(iterations: Int, checksum: Int): String {
